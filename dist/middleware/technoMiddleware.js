...
var TechnoMiddleware = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req;
                        return [4, technoModel_1.default.findById(req.params.id)];
                    case 1:
                        _a.techno = (_b.sent());
                        if (!req.techno) {
                            req.flash("error", "Techno not found");
                            return [2, res.redirect("/admin/technos")];
                        }
                        next();
                        return [2];
                }
    ...
    TechnoMiddleware.prototype.validNew = function (req, res, next) {
        var validator = new validator_1.default.techno(req.body);
    ...
    return TechnoMiddleware;
}());
exports.default = TechnoMiddleware;
